...
3. From repo root, identify the ASDP Anchor (Code Root). If missing, run the initialization workflow.
     > **Workflow**: `asdp-init`
...
5. For each project folder (depth-first), starting from the Anchor:
   ...
   - Update the anchor's `codetree.md`.
