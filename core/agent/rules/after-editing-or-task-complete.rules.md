...
- If folder structure changed (add/remove/rename/move), update root `codetree.md` and also follow `WHEN_CREATING_A_FOLDER` or `WHEN_DELETING_A_FOLDER` as applicable.
